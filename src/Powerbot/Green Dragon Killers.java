...
public class GreenDragonKiller extends ActiveScript implements PaintListener, MessageListener {
  ...
  /**
	...
	int BeenKilled;
		...
		public final Area bankArea = new Area(new Tile[] {new Tile(3178, 3449, 0), new Tile(3178, 3448, 0),new Tile(3183, 3448, 0), new Tile(3188, 3448, 0),new Tile(3192, 3445, 0), new Tile(3194, 3440, 0),new Tile(3194, 3435, 0), new Tile(3191, 3431, 0),new Tile(3186, 3431, 0), new Tile(3180, 3431, 0)});
		public final Area DragonArea = new Area(new Tile[] {new Tile(3325, 3717, 0), new Tile(3326, 3717, 0),new Tile(3332, 3718, 0), new Tile(3337, 3718, 0),new Tile(3345, 3718, 0), new Tile(3350, 3718, 0), new Tile(3355, 3718, 0), new Tile(3359, 3715, 0),new Tile(3361, 3710, 0), new Tile(3361, 3705, 0),new Tile(3361, 3698, 0), new Tile(3363, 3693, 0),new Tile(3362, 3686, 0), new Tile(3362, 3681, 0),new Tile(3362, 3676, 0), new Tile(3362, 3671, 0),new Tile(3358, 3668, 0), new Tile(3353, 3667, 0),new Tile(3348, 3667, 0), new Tile(3343, 3668, 0),new Tile(3339, 3671, 0), new Tile(3334, 3671, 0),new Tile(3329, 3669, 0)});
		public final Area wallArea = new Area(new Tile[] {new Tile(3136, 3527, 0), new Tile(3135, 3527, 0),new Tile(3141, 3527, 0), new Tile(3147, 3525, 0),new Tile(3144, 3519, 0), new Tile(3140, 3516, 0),new Tile(3134, 3516, 0)});
	...
	public int getWildernessLevel() {
        return isinWild() ? Integer.parseInt(Widgets.get(381, 2).getText().replaceAll("Level: ", "")) : 0; //Gets the Current Wild Level 
    }
